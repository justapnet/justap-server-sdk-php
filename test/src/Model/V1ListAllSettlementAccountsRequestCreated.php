...
/**
 * V1ListAllSettlementAccountsRequestCreated Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1ListAllSettlementAccountsRequestCreated implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1ListAllSettlementAccountsRequestCreated';
    ...
    {
        $this->container['gt'] = isset($data['gt']) ? $data['gt'] : 0;
        $this->container['gte'] = isset($data['gte']) ? $data['gte'] : 0;
        $this->container['lt'] = isset($data['lt']) ? $data['lt'] : 0;
        $this->container['lte'] = isset($data['lte']) ? $data['lte'] : 0;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['gte'] === null) {
            $invalidProperties[] = "'gte' can't be null";
        }
     ...
     * Sets gt
     *
     * @param int $gt 小于 charge 对象的创建时间，用 Unix 时间戳表示
     *
     * @return $this
     */
     ...
     * Sets gte
     *
     * @param int $gte 小于或等于 charge 对象的创建时间，用 Unix 时间戳表示
     *
     * @return $this
     */
     ...
     * Sets lt
     *
     * @param int $lt 大于 charge 对象的创建时间，用 Unix 时间戳表示
     *
     * @return $this
     */
     ...
     * Sets lte
     *
     * @param int $lte 大于或等于 charge 对象的创建时间，用 Unix 时间戳表示
     *
     * @return $this
     */
