...
class SettlementAccountRecipientWechatpayChannelRecipient implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['sub_app_id'] = isset($data['sub_app_id']) ? $data['sub_app_id'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['force_check'] === null) {
            $invalidProperties[] = "'force_check' can't be null";
        }
        if ($this->container['name'] === null) {
            $invalidProperties[] = "'name' can't be null";
        }
        if ($this->container['sub_app_id'] === null) {
            $invalidProperties[] = "'sub_app_id' can't be null";
        }
     ...
     * Sets app_id
     *
     * @param string $app_id 微信支付分账接收方 openid 所对应的服务商公众号 ID
     *
     * @return $this
     */
    ...
    {
        return $this->container['sub_app_id'];
    }

    /**
     * Sets sub_app_id
     *
     * @param string $sub_app_id 微信支付分账接收方 openid 所对应的商户公众号 ID
     *
     * @return $this
     */
    public function setSubAppId($sub_app_id)
    {
        $this->container['sub_app_id'] = $sub_app_id;
