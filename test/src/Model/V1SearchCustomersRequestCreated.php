...
/**
 * V1SearchCustomersRequestCreated Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1SearchCustomersRequestCreated implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1SearchCustomersRequestCreated';
     ...
     * Sets gt
     *
     * @param int $gt 小于 BusinessUser 对象的创建时间，用 Unix 时间戳表示
     *
     * @return $this
     */
     ...
     * Sets gte
     *
     * @param int $gte 小于或等于 BusinessUser 对象的创建时间，用 Unix 时间戳表示
     *
     * @return $this
     */
     ...
     * Sets lt
     *
     * @param int $lt 大于 BusinessUser 对象的创建时间，用 Unix 时间戳表示
     *
     * @return $this
     */
     ...
     * Sets lte
     *
     * @param int $lte 大于或等于 BusinessUser 对象的创建时间，用 Unix 时间戳表示
     *
     * @return $this
     */
