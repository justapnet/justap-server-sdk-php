...
/**
 * V1ExtraWechatpayLite Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1ExtraWechatpayLite implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1ExtraWechatpayLite';
    ...
    protected static $swaggerTypes = [
        'applet_config' => '\Justapnet\Justap\Model\V1ExtraWechatpayAppletConfig',
        'attach' => 'string',
    ...
    {
        $this->container['applet_config'] = isset($data['applet_config']) ? $data['applet_config'] : null;
        ...
        $this->container['prepay_id'] = isset($data['prepay_id']) ? $data['prepay_id'] : null;
     ...
     * Gets applet_config
     *
     * @return \Justapnet\Justap\Model\V1ExtraWechatpayAppletConfig
     */
    public function getAppletConfig()
    {
        return $this->container['applet_config'];
    }

    /**
     * Sets applet_config
     *
     * @param \Justapnet\Justap\Model\V1ExtraWechatpayAppletConfig $applet_config applet_config
     *
     * @return $this
     */
    public function setAppletConfig($applet_config)
    {
        $this->container['applet_config'] = $applet_config;
