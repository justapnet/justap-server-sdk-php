...
/**
 * V1RoyaltySettlementTransaction Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1RoyaltySettlementTransaction implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1RoyaltySettlementTransaction';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['object'] = isset($data['object']) ? $data['object'] : 'RoyaltySettlementTransaction';
        $this->container['recipient_app_id'] = isset($data['recipient_app_id']) ? $data['recipient_app_id'] : null;
        ...
        $this->container['user_settlement_account_id'] = isset($data['user_settlement_account_id']) ? $data['user_settlement_account_id'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['recipient_app_id'] === null) {
            $invalidProperties[] = "'recipient_app_id' can't be null";
        }
        ...
        if ($this->container['user_settlement_account_id'] === null) {
            $invalidProperties[] = "'user_settlement_account_id' can't be null";
        }
    ...
    /**
     * Gets recipient_app_id
     *
     * @return string
     */
    public function getRecipientAppId()
    {
        return $this->container['recipient_app_id'];
    }

    /**
     * Sets recipient_app_id
     *
     * @param string $recipient_app_id 接收方 App ID
     *
     * @return $this
     */
    public function setRecipientAppId($recipient_app_id)
    {
        $this->container['recipient_app_id'] = $recipient_app_id;
     ...
     *
     * @param string $recipient_user_id 接收方用户 ID
     *
     * @return $this
     */
     ...
     * Sets transfer_id
     *
     * @param string $transfer_id 支付平分账处理流水 ID
     *
     * @return $this
     */
    ...
    /**
     * Gets user_settlement_account_id
     *
     * @return string
     */
    public function getUserSettlementAccountId()
    {
        return $this->container['user_settlement_account_id'];
    }

    /**
     * Sets user_settlement_account_id
     *
     * @param string $user_settlement_account_id 接收方用户结算账户 ID
     *
     * @return $this
     */
    public function setUserSettlementAccountId($user_settlement_account_id)
    {
        $this->container['user_settlement_account_id'] = $user_settlement_account_id;
