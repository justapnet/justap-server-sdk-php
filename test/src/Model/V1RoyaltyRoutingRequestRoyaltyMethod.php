...
/**
 * V1RoyaltyRoutingRequestRoyaltyMethod Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1RoyaltyRoutingRequestRoyaltyMethod
{
    /**
     * Possible values of this enum
     */
    const ROYALTY_METHOD_UNKNOWN = 'ROYALTY_METHOD_UNKNOWN';
    const CREATE_ROYALTY = 'CREATE_ROYALTY';
    const QUERY_ROYALTY = 'QUERY_ROYALTY';
    const FINISH_ROYALTY = 'Finish_ROYALTY';
    const RETURN_ROYALTY = 'RETURN_ROYALTY';
    const QUERY_RETURN_ROYALTY = 'QUERY_RETURN_ROYALTY';
    ...
    {
        return [
            self::ROYALTY_METHOD_UNKNOWN,
            self::CREATE_ROYALTY,
            self::QUERY_ROYALTY,
            self::FINISH_ROYALTY,
            self::RETURN_ROYALTY,
            self::QUERY_RETURN_ROYALTY,
        ];
    }
}
