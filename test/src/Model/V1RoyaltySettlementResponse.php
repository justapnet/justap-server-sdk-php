...
/**
 * V1RoyaltySettlementResponse Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1RoyaltySettlementResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1RoyaltySettlementResponse';
     ...
     * Sets data
     *
     * @param \Justapnet\Justap\Model\V1RoyaltySettlement $data 分账结算单
     *
     * @return $this
     */
