...
/**
 * V1CreateRoyaltyRequest Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1CreateRoyaltyRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1CreateRoyaltyRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'charge_id' => 'string',
        'order_id' => 'string',
        'receivers' => '\Justapnet\Justap\Model\CreateRoyaltyRequestRoyaltyReceiver[]'
    ];
     ...
     * Sets callback_url
     *
     * @param string $callback_url 结果通知地址
     *
     * @return $this
     */
     ...
     * Gets receivers
     *
     * @return \Justapnet\Justap\Model\CreateRoyaltyRequestRoyaltyReceiver[]
     */
     ...
     * Sets receivers
     *
     * @param \Justapnet\Justap\Model\CreateRoyaltyRequestRoyaltyReceiver[] $receivers 分润接受方列表
     *
     * @return $this
     */
