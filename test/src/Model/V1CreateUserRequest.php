...
/**
 * V1CreateUserRequest Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1CreateUserRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1CreateUserRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'disabled' => 'bool',
        'email' => 'string',
        'gender' => '\Justapnet\Justap\Model\V1Gender',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['out_user_id'] = isset($data['out_user_id']) ? $data['out_user_id'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['out_user_id'] === null) {
            $invalidProperties[] = "'out_user_id' can't be null";
        }
        ...
        if ($this->container['withdrawable_balance'] === null) {
            $invalidProperties[] = "'withdrawable_balance' can't be null";
        }
     ...
     * Sets address
     *
     * @param string $address [OPTIONAL] 用户地址
     *
     * @return $this
     */
     ...
     *
     * @param float $available_balance [OPTIONAL] 用户可用余额
     *
     * @return $this
     */
     ...
     * Sets avatar
     *
     * @param string $avatar [OPTIONAL] 用户头像
     *
     * @return $this
     */
     ...
     * Sets created
     *
     * @param int $created [OPTIONAL] 用户创建时间
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param string $currency [OPTIONAL] 用户货币
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description [OPTIONAL] 用户描述
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string $email [OPTIONAL] 用户邮箱
     *
     * @return $this
     */
     ...
     * Gets gender
     *
     * @return \Justapnet\Justap\Model\V1Gender
     */
     ...
     * Sets gender
     *
     * @param \Justapnet\Justap\Model\V1Gender $gender [OPTIONAL] 用户性别
     *
     * @return $this
     */
     ...
     * Sets metadata
     *
     * @param map[string,string] $metadata [OPTIONAL] 用户元数据
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name [OPTIONAL] 用户名
     *
     * @return $this
     */
     ...
     * Sets nickname
     *
     * @param string $nickname [OPTIONAL] 用户昵称
     *
     * @return $this
     */
    ...
    {
        return $this->container['out_user_id'];
    }

    /**
     * Sets out_user_id
     *
     * @param string $out_user_id [REQUIRED] 商户系统用户 ID
     *
     * @return $this
     */
    public function setOutUserId($out_user_id)
    {
        $this->container['out_user_id'] = $out_user_id;
     ...
     * Sets parent_user_id
     *
     * @param string $parent_user_id [OPTIONAL] 父用户 ID
     *
     * @return $this
     */
     ...
     * Sets phone
     *
     * @param string $phone [OPTIONAL] 用户手机号
     *
     * @return $this
     */
     ...
     *
     * @param float $withdrawable_balance [OPTIONAL] 用户可提现余额
     *
     * @return $this
     */
