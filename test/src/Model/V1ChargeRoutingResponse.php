...
/**
 * V1ChargeRoutingResponse Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1ChargeRoutingResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1ChargeRoutingResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['transaction_id'] = isset($data['transaction_id']) ? $data['transaction_id'] : 0;
    }
     ...
     * Sets error
     *
     * @param \Justapnet\Justap\Model\V1ServiceError $error 错误信息
     *
     * @return $this
     */
     ...
     * Sets transaction_id
     *
     * @param int $transaction_id 支付单 ID
     *
     * @return $this
     */
