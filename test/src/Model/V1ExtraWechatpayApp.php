...
/**
 * V1ExtraWechatpayApp Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1ExtraWechatpayApp implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1ExtraWechatpayApp';
    ...
    protected static $swaggerTypes = [
        'app_config' => '\Justapnet\Justap\Model\V1ExtraWechatpayAppConfig',
        'attach' => 'string',
    ...
    {
        $this->container['app_config'] = isset($data['app_config']) ? $data['app_config'] : null;
     ...
     * Gets app_config
     *
     * @return \Justapnet\Justap\Model\V1ExtraWechatpayAppConfig
     */
    public function getAppConfig()
    {
        return $this->container['app_config'];
    }

    /**
     * Sets app_config
     *
     * @param \Justapnet\Justap\Model\V1ExtraWechatpayAppConfig $app_config app拉起支付配置信息
     *
     * @return $this
     */
    public function setAppConfig($app_config)
    {
        $this->container['app_config'] = $app_config;
