...
/**
 * CreateRoyaltyRequestRoyaltyMode Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateRoyaltyRequestRoyaltyMode
{
    /**
     * Possible values of this enum
     */
    const ROYALTY_MODE_UNSET = 'ROYALTY_MODE_UNSET';
    const FIXED = 'FIXED';
    const RATE = 'RATE';
