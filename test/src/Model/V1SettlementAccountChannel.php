...
/**
 * V1SettlementAccountChannel Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1SettlementAccountChannel
{
    /**
     * Possible values of this enum
     */
    const CHANNEL_UNKNOWN = 'CHANNEL_UNKNOWN';
    const ALIPAY = 'ALIPAY';
    const WECHATPAY = 'WECHATPAY';
    const BANK = 'BANK';
    const BALANCE = 'BALANCE';
    const YSEPAY_MERCHANT = 'YSEPAY_MERCHANT';
