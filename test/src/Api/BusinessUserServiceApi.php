...
/**
 * BusinessUserServiceApi Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
...
class BusinessUserServiceApi
{
     ...
     * @param  string $parent_user_id parent_user_id (optional)
     *
     * @throws \Justapnet\Justap\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Justapnet\Justap\Model\V1UserResponse
     */
    public function businessUserServiceUpdateUser($id, $app_id = null, $address = null, $currency = null, $description = null, $email = null, $name = null, $phone = null, $avatar = null, $disabled = null, $gender = 'GENDER_UNKNOWN', $parent_user_id = null)
    {
        list($response) = $this->businessUserServiceUpdateUserWithHttpInfo($id, $app_id, $address, $currency, $description, $email, $name, $phone, $avatar, $disabled, $gender, $parent_user_id);
        return $response;
    }
     ...
     * @param  string $gender - GENDER_UNKNOWN: 未设置  - MALE: 男  - FE_MALE: 女  - PRIVACY: 保密  - ThirdGender: 第三性别 (optional, default to GENDER_UNKNOWN)
     * @param  string $parent_user_id (optional)
     *
     * @throws \Justapnet\Justap\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Justapnet\Justap\Model\V1UserResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function businessUserServiceUpdateUserWithHttpInfo($id, $app_id = null, $address = null, $currency = null, $description = null, $email = null, $name = null, $phone = null, $avatar = null, $disabled = null, $gender = 'GENDER_UNKNOWN', $parent_user_id = null)
    {
        $returnType = '\Justapnet\Justap\Model\V1UserResponse';
        $request = $this->businessUserServiceUpdateUserRequest($id, $app_id, $address, $currency, $description, $email, $name, $phone, $avatar, $disabled, $gender, $parent_user_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function businessUserServiceUpdateUserAsync($id, $app_id = null, $address = null, $currency = null, $description = null, $email = null, $name = null, $phone = null, $avatar = null, $disabled = null, $gender = 'GENDER_UNKNOWN', $parent_user_id = null)
    {
        return $this->businessUserServiceUpdateUserAsyncWithHttpInfo($id, $app_id, $address, $currency, $description, $email, $name, $phone, $avatar, $disabled, $gender, $parent_user_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function businessUserServiceUpdateUserAsyncWithHttpInfo($id, $app_id = null, $address = null, $currency = null, $description = null, $email = null, $name = null, $phone = null, $avatar = null, $disabled = null, $gender = 'GENDER_UNKNOWN', $parent_user_id = null)
    {
        $returnType = '\Justapnet\Justap\Model\V1UserResponse';
        $request = $this->businessUserServiceUpdateUserRequest($id, $app_id, $address, $currency, $description, $email, $name, $phone, $avatar, $disabled, $gender, $parent_user_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function businessUserServiceUpdateUserRequest($id, $app_id = null, $address = null, $currency = null, $description = null, $email = null, $name = null, $phone = null, $avatar = null, $disabled = null, $gender = 'GENDER_UNKNOWN', $parent_user_id = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling businessUserServiceUpdateUser'
            );
        }
        ...
        if ($parent_user_id !== null) {
            $queryParams['parent_user_id'] = ObjectSerializer::toQueryValue($parent_user_id);
        }
