...
class CustomerServiceApi
{
     ...
     * @param  string $gender - GENDER_UNKNOWN: 未设置  - MALE: 男  - FE_MALE: 女  - PRIVACY: 保密  - ThirdGender: 第三性别 (optional, default to GENDER_UNKNOWN)
     * @param  string $parent_customer_id parent_customer_id (optional)
     * @param  string $out_customer_id out_customer_id (optional)
     *
     * @throws \Justapnet\Justap\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Justapnet\Justap\Model\V1CustomerResponse
     */
    public function customerServiceUpdateCustomer($id, $app_id = null, $address = null, $currency = null, $description = null, $email = null, $name = null, $phone = null, $avatar = null, $disabled = null, $gender = 'GENDER_UNKNOWN', $parent_customer_id = null, $out_customer_id = null)
    {
        list($response) = $this->customerServiceUpdateCustomerWithHttpInfo($id, $app_id, $address, $currency, $description, $email, $name, $phone, $avatar, $disabled, $gender, $parent_customer_id, $out_customer_id);
        return $response;
    }
     ...
     * @param  string $gender - GENDER_UNKNOWN: 未设置  - MALE: 男  - FE_MALE: 女  - PRIVACY: 保密  - ThirdGender: 第三性别 (optional, default to GENDER_UNKNOWN)
     * @param  string $parent_customer_id (optional)
     * @param  string $out_customer_id (optional)
     *
     * @throws \Justapnet\Justap\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Justapnet\Justap\Model\V1CustomerResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function customerServiceUpdateCustomerWithHttpInfo($id, $app_id = null, $address = null, $currency = null, $description = null, $email = null, $name = null, $phone = null, $avatar = null, $disabled = null, $gender = 'GENDER_UNKNOWN', $parent_customer_id = null, $out_customer_id = null)
    {
        $returnType = '\Justapnet\Justap\Model\V1CustomerResponse';
        $request = $this->customerServiceUpdateCustomerRequest($id, $app_id, $address, $currency, $description, $email, $name, $phone, $avatar, $disabled, $gender, $parent_customer_id, $out_customer_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerServiceUpdateCustomerAsync($id, $app_id = null, $address = null, $currency = null, $description = null, $email = null, $name = null, $phone = null, $avatar = null, $disabled = null, $gender = 'GENDER_UNKNOWN', $parent_customer_id = null, $out_customer_id = null)
    {
        return $this->customerServiceUpdateCustomerAsyncWithHttpInfo($id, $app_id, $address, $currency, $description, $email, $name, $phone, $avatar, $disabled, $gender, $parent_customer_id, $out_customer_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customerServiceUpdateCustomerAsyncWithHttpInfo($id, $app_id = null, $address = null, $currency = null, $description = null, $email = null, $name = null, $phone = null, $avatar = null, $disabled = null, $gender = 'GENDER_UNKNOWN', $parent_customer_id = null, $out_customer_id = null)
    {
        $returnType = '\Justapnet\Justap\Model\V1CustomerResponse';
        $request = $this->customerServiceUpdateCustomerRequest($id, $app_id, $address, $currency, $description, $email, $name, $phone, $avatar, $disabled, $gender, $parent_customer_id, $out_customer_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function customerServiceUpdateCustomerRequest($id, $app_id = null, $address = null, $currency = null, $description = null, $email = null, $name = null, $phone = null, $avatar = null, $disabled = null, $gender = 'GENDER_UNKNOWN', $parent_customer_id = null, $out_customer_id = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // query params
        if ($avatar !== null) {
            $queryParams['avatar'] = ObjectSerializer::toQueryValue($avatar);
        }
        // query params
        if ($disabled !== null) {
            $queryParams['disabled'] = ObjectSerializer::toQueryValue($disabled);
        ...
        if ($parent_customer_id !== null) {
            $queryParams['parent_customer_id'] = ObjectSerializer::toQueryValue($parent_customer_id);
        }
        // query params
        if ($out_customer_id !== null) {
            $queryParams['out_customer_id'] = ObjectSerializer::toQueryValue($out_customer_id);
        }
