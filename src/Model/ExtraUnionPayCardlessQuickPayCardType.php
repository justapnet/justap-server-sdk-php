...
/**
 * ExtraUnionPayCardlessQuickPayCardType Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExtraUnionPayCardlessQuickPayCardType
{
    /**
     * Possible values of this enum
     */
    const CARD_TYPE_UNSET = 'CardTypeUnset';
    const CREDIT = 'Credit';
    const DEBIT = 'Debit';
