...
/**
 * V1ChargeListResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1ChargeListResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1ChargeListResponse';
    ...
    protected static $swaggerTypes = [
        'data' => '\Justapnet\Justap\Model\V1Charge[]',
        'has_more' => 'bool',
        'object' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \Justapnet\Justap\Model\V1Charge[]
     */
     ...
     * Sets data
     *
     * @param \Justapnet\Justap\Model\V1Charge[] $data 包含一个由请求参数分页后的返回对象实体
     *
     * @return $this
     */
     ...
     * Sets has_more
     *
     * @param bool $has_more 表明获取列表之后是否还有更多的元素实体。如果值为 false，表明当前页是最后一页
     *
     * @return $this
     */
