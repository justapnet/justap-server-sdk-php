...
/**
 * V1ExtraAlipayFace Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1ExtraAlipayFace implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1ExtraAlipayFace';
    ...
    {
        $this->container['hahaha'] = isset($data['hahaha']) ? $data['hahaha'] : null;
    }
     ...
     * @return string
     */
    public function getHahaha()
    {
        return $this->container['hahaha'];
    }

    /**
     * Sets hahaha
     *
     * @param string $hahaha hahaha
     *
     * @return $this
     */
    public function setHahaha($hahaha)
    {
        $this->container['hahaha'] = $hahaha;
