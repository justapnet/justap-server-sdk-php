...
/**
 * V1ChargeExtra Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1ChargeExtra implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1ChargeExtra';
     ...
     * Sets alipay_app
     *
     * @param \Justapnet\Justap\Model\V1ExtraAlipayApp $alipay_app 支付宝 App 支付渠道元数据
     *
     * @return $this
     */
     ...
     * Sets alipay_face
     *
     * @param \Justapnet\Justap\Model\V1ExtraAlipayFace $alipay_face 支付宝 刷脸 支付渠道元数据
     *
     * @return $this
     */
     ...
     * Sets alipay_jsapi
     *
     * @param \Justapnet\Justap\Model\V1ExtraAlipayJSAPI $alipay_jsapi 支付宝 JSAPI 支付渠道元数据
     *
     * @return $this
     */
     ...
     * Sets alipay_lite
     *
     * @param \Justapnet\Justap\Model\V1ExtraAlipayLite $alipay_lite 支付宝 小程序 支付渠道元数据
     *
     * @return $this
     */
     ...
     * Sets alipay_page
     *
     * @param \Justapnet\Justap\Model\V1ExtraAlipayPage $alipay_page 支付宝 电脑网站 支付渠道元数据
     *
     * @return $this
     */
     ...
     * Sets alipay_qr
     *
     * @param \Justapnet\Justap\Model\V1ExtraAlipayQr $alipay_qr 支付宝 当面付 支付渠道元数据
     *
     * @return $this
     */
     ...
     * Sets alipay_scan
     *
     * @param \Justapnet\Justap\Model\V1ExtraAlipayScan $alipay_scan 支付宝 扫码(被扫) 支付渠道元数据
     *
     * @return $this
     */
     ...
     * Sets alipay_wap
     *
     * @param \Justapnet\Justap\Model\V1ExtraAlipayWap $alipay_wap 支付宝 手机网站 支付渠道元数据
     *
     * @return $this
     */
     ...
     * Sets wechatpay_app
     *
     * @param \Justapnet\Justap\Model\V1ExtraWechatpayApp $wechatpay_app 微信支付 App 支付渠道元数据
     *
     * @return $this
     */
     ...
     * Sets wechatpay_h5
     *
     * @param \Justapnet\Justap\Model\V1ExtraWechatpayH5 $wechatpay_h5 微信支付 H5 支付渠道元数据
     *
     * @return $this
     */
     ...
     *
     * @param \Justapnet\Justap\Model\V1ExtraWechatpayJsapi $wechatpay_jsapi 微信支付 公众号 支付渠道元数据
     *
     * @return $this
     */
     ...
     * Sets wechatpay_lite
     *
     * @param \Justapnet\Justap\Model\V1ExtraWechatpayLite $wechatpay_lite 微信支付 小程序 支付渠道元数据
     *
     * @return $this
     */
     ...
     *
     * @param \Justapnet\Justap\Model\V1ExtraWechatpayNative $wechatpay_native 微信支付 扫码(被扫) 支付渠道元数据
     *
     * @return $this
     */
     ...
     * Sets wechatpay_scan
     *
     * @param \Justapnet\Justap\Model\V1ExtraWechatpayScan $wechatpay_scan 微信支付 扫码(被扫) 支付渠道元数据
     *
     * @return $this
     */
