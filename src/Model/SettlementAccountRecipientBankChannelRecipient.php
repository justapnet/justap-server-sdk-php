...
/**
 * SettlementAccountRecipientBankChannelRecipient Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SettlementAccountRecipientBankChannelRecipient implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SettlementAccountRecipientBankChannelRecipient';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bank_city'] === null) {
            $invalidProperties[] = "'bank_city' can't be null";
        }
        if ($this->container['bank_name'] === null) {
            $invalidProperties[] = "'bank_name' can't be null";
        }
        if ($this->container['bank_province'] === null) {
            $invalidProperties[] = "'bank_province' can't be null";
        }
     ...
     * Sets bank_branch
     *
     * @param string $bank_branch 银行卡开户支行
     *
     * @return $this
     */
     ...
     * Sets bank_city
     *
     * @param string $bank_city 银行卡开户城市
     *
     * @return $this
     */
     ...
     * Sets bank_name
     *
     * @param string $bank_name 银行卡开户行编码
     *
     * @return $this
     */
     ...
     * Sets bank_province
     *
     * @param string $bank_province 银行卡开户省份
     *
     * @return $this
     */
