...
/**
 * RoyaltySettlementRoyaltySettlementStatus Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RoyaltySettlementRoyaltySettlementStatus
{
    /**
     * Possible values of this enum
     */
    const ROYALTY_SETTLEMENT_STATUS_UNSET = 'RoyaltySettlementStatusUnset';
    ...
    {
        return [
            self::ROYALTY_SETTLEMENT_STATUS_UNSET,
            self::CREATED,
            self::PENDING,
            self::COMPLETED,
        ];
