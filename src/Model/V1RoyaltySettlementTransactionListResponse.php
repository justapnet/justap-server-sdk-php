...
/**
 * V1RoyaltySettlementTransactionListResponse Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1RoyaltySettlementTransactionListResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1RoyaltySettlementTransactionListResponse';
    ...
    protected static $swaggerTypes = [
        'data' => '\Justapnet\Justap\Model\V1RoyaltySettlementTransaction',
        'has_more' => 'bool',
        'object' => 'string'
    ];
     ...
     * Sets data
     *
     * @param \Justapnet\Justap\Model\V1RoyaltySettlementTransaction $data data
     *
     * @return $this
     */
