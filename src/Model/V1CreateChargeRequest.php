...
/**
 * V1CreateChargeRequest Class Doc Comment
 *
 * @category Class
 * @description 你可以创建一个 charge 对象向用户收款。charge 是一个支付凭据对象，所有和支付相关的要素信息都存储在这个对象中，你的服务端可以通过发起支付请求来创建一个新的 charge 对象，也可以随时查询一个或者多个 charge 对象的状态。每个 charge 对象都拥有一个标识 id，该 id 在系统内唯一。
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1CreateChargeRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1CreateChargeRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'currency' => 'string',
        'description' => 'string',
        'extra' => '\Justapnet\Justap\Model\V1CreateChargeRequestExtra',
     ...
     * Sets amount
     *
     * @param float $amount [REQUIRED] 订单金额，单位元， 如 0.01
     *
     * @return $this
     */
     ...
     * Sets app_id
     *
     * @param string $app_id [REQUIRED] 应用 id
     *
     * @return $this
     */
     ...
     * Sets body
     *
     * @param string $body [REQUIRED] 服务明细
     *
     * @return $this
     */
     ...
     * Sets callback_url
     *
     * @param string $callback_url [OPTIONAL] 回调地址，如不传则使用 APP 设置中的回调地址。若都为空，则无法跳回原页面
     *
     * @return $this
     */
     ...
     * Sets channel
     *
     * @param \Justapnet\Justap\Model\V1Channel $channel channel
     *
     * @return $this
     */
     ...
     * Sets client_ip
     *
     * @param string $client_ip [REQUIRED] 客户端机器 IP
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param string $currency 货币单位。国内收单机构仅支持 CNY
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description [OPTIONAL] 交易描述
     *
     * @return $this
     */
     ...
     * Gets extra
     *
     * @return \Justapnet\Justap\Model\V1CreateChargeRequestExtra
     */
     ...
     * Sets extra
     *
     * @param \Justapnet\Justap\Model\V1CreateChargeRequestExtra $extra extra
     *
     * @return $this
     */
     ...
     * Sets metadata
     *
     * @param map[string,string] $metadata [OPTIONAL] 订单元数据，原样返回
     *
     * @return $this
     */
     ...
     * Sets notify_url
     *
     * @param string $notify_url [OPTIONAL] 通知地址，如不传则使用 APP 设置中的通知地址。若都为空，则不发送通知
     *
     * @return $this
     */
     ...
     * Sets subject
     *
     * @param string $subject [REQUIRED] 物品或服务名称（交易标题）
     *
     * @return $this
     */
     ...
     * Sets ttl
     *
     * @param int $ttl [OPTIONAL] 订单超时时间，单位秒
     *
     * @return $this
     */
