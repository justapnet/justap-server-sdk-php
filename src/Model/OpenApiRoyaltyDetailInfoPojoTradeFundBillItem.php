...
/**
 * OpenApiRoyaltyDetailInfoPojoTradeFundBillItem Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OpenApiRoyaltyDetailInfoPojoTradeFundBillItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OpenApiRoyaltyDetailInfoPojoTradeFundBillItem';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['fund_channel'] = isset($data['fund_channel']) ? $data['fund_channel'] : null;
        $this->container['fund_type'] = isset($data['fund_type']) ? $data['fund_type'] : null;
        $this->container['real_amount'] = isset($data['real_amount']) ? $data['real_amount'] : null;
    }
     ...
     * Sets fund_channel
     *
     * @param string $fund_channel 资金渠道
     *
     * @return $this
     */
     ...
     * Sets fund_type
     *
     * @param string $fund_type 渠道所使用的资金类型
     *
     * @return $this
     */
     ...
     * Sets real_amount
     *
     * @param float $real_amount 渠道实际付款金额
     *
     * @return $this
     */
