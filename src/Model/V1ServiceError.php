...
/**
 * V1ServiceError Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1ServiceError implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1ServiceError';
    ...
    {
        $this->container['error_code'] = isset($data['error_code']) ? $data['error_code'] : 0;
     ...
     * Sets error_reason
     *
     * @param string $error_reason 错误原因
     *
     * @return $this
     */
