...
/**
 * V1UnionQrRequest Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1UnionQrRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1UnionQrRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['browser_agent'] = isset($data['browser_agent']) ? $data['browser_agent'] : null;
        $this->container['i'] = isset($data['i']) ? $data['i'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['browser_agent'] === null) {
            $invalidProperties[] = "'browser_agent' can't be null";
        }
        if ($this->container['i'] === null) {
            $invalidProperties[] = "'i' can't be null";
        }
        if ($this->container['in_app'] === null) {
            $invalidProperties[] = "'in_app' can't be null";
        }
     ...
     * Sets appid
     *
     * @param string $appid openid 对应的应用id
     *
     * @return $this
     */
    ...
    {
        return $this->container['browser_agent'];
    }

    /**
     * Sets browser_agent
     *
     * @param string $browser_agent 浏览器信息
     *
     * @return $this
     */
    public function setBrowserAgent($browser_agent)
    {
        $this->container['browser_agent'] = $browser_agent;
     ...
     * Sets in_app
     *
     * @param string $in_app 打开的app类型，微信/支付宝/qq/闪付
     *
     * @return $this
     */
