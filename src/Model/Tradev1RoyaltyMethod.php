...
/**
 * Tradev1RoyaltyMethod Class Doc Comment
 *
 * @category Class
 * @package  Justapnet\Justap
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Tradev1RoyaltyMethod
{
    /**
     * Possible values of this enum
     */
    const ROYALTY_METHOD_UNSET = 'RoyaltyMethodUnset';
    const BALANCE = 'Balance';
    const ALIPAY = 'Alipay';
    const WECHATPAY = 'Wechatpay';
    const YSEPAY_MERCHANT = 'YsepayMerchant';
    ...
    {
        return [
            self::ROYALTY_METHOD_UNSET,
            self::BALANCE,
            self::ALIPAY,
            self::WECHATPAY,
            self::YSEPAY_MERCHANT,
        ];
    }
}
